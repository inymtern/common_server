<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="是否使用过" prop="isUse">
        <el-input
          ...
          placeholder="请输入是否使用过"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="口令" prop="keyStr">
        <el-input
          v-model="queryParams.keyStr"
          placeholder="请输入口令"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="articleList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="口令" align="center" prop="keyStr" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="口令" prop="keyStr">
          <el-input v-model="form.keyStr" placeholder="请输入口令" />
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除文案编号为"' + ids + '"的数据项？').then(function() {
